...
@Component({
    selector: 'jhi-temp-meter-pond-suffix',
    templateUrl: './temp-meter-pond-suffix.component.html'
})
export class TempMeterPondSuffixComponent implements OnInit, OnDestroy {

    tempMeters: TempMeterPondSuffix[];
    currentAccount: any;
    ...
    trackId (index: number, item: TempMeterPondSuffix) {
        return item.id;
    }
