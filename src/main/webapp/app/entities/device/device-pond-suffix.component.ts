...
@Component({
    selector: 'jhi-device-pond-suffix',
    templateUrl: './device-pond-suffix.component.html'
})
export class DevicePondSuffixComponent implements OnInit, OnDestroy {
    ...
    trackId (index: number, item: DevicePondSuffix) {
        return item.id;
    }
