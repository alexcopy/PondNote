...
@Injectable()
export class ChemicalAnalysisPondSuffixService {

    private resourceUrl = 'api/chemical-analyses';
    private resourceSearchUrl = 'api/_search/chemical-analyses';
    ...
    find(id: number): Observable<ChemicalAnalysisPondSuffix> {
